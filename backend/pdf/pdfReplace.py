...
# Add the Electro Volt Technician info
    ...
    doc.build(elements, onFirstPage=lambda canvas, doc: canvas_first_page(canvas, doc, header_style),
...
if __name__ == "__main__":
    with open('./backend/pdf/resources/data.json') as json_file:
        data = json.load(json_file)
    print(return_pdf(data))
